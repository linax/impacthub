...
const products = [
  ...
  {
    id: 8,
    name: "Escultura 'Conexión' - Carlos Mendoza",
    category: "arte",
    price: "$200.000",
    image: "/sculpture-conexion.png",
    artist: "Carlos Mendoza",
    artistImage: "/artist-carlos.png",
    description: "Escultura en arcilla que simboliza las conexiones humanas y la inclusión.",
    impact: "Financia 2 meses de materiales de arte para el taller",
  ...
  {
    id: 9,
    name: "Collage Digital 'Diversidad' - Ana Rodríguez",
    category: "arte",
    price: "$80.000",
    image: "/digital-diversidad.png",
    artist: "Ana Rodríguez",
    artistImage: "/artist-ana.png",
  ...
  {
    id: 11,
    name: "Cupo Semestral - Taller de Arte Terapéutico",
    category: "donacion",
    price: "$250.000",
    image: "/cupo-arte-terapia.png",
    artist: "Centro UC SD Down",
    artistImage: "/uc-logo.png",
    description: "Patrocina un cupo en el taller de arte terapéutico por 6 meses.",
    impact: "1 persona accede a terapia a través del arte por 6 meses",
    features: ["Sesiones semanales", "Materiales incluidos", "Evaluación psicológica", "Certificado de participación"],
    bestseller: false,
    sustainability: "Bienestar emocional",
  },
  {
    id: 12,
    ...
    category: "donacion",
    price: "$100.000",
    image: "/cupo-vida-independiente.png",
    artist: "Fundación Complementa",
    artistImage: "/fundacion-logo.png",
